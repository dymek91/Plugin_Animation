...
; The file to write
OutFile "Plugin_Animation_${VERSION}.exe"
...
; Sections
Section "Animation" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\Animation"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\Animation\Plugin_Animation.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\Animation\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\Animation"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\Animation\Plugin_Animation.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\Animation\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_Animation"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_Animation\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Animation Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the Animation Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Animation Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_Animation\changelog.md"'
FunctionEnd
