...
{
    CPluginAnimation* gPlugin = NULL;

    CPluginAnimation::CPluginAnimation()
    {
        gPlugin = this;
    }
    ...
    bool CPluginAnimation::Release( bool bForce )
    {
        bool bRet = true;
    ...
    bool CPluginAnimation::Init( SSystemGlobalEnvironment& env, SSystemInitParams& startupParams, IPluginBase* pPluginManager, const char* sPluginDirectory )
    {
    ...
    bool CPluginAnimation::RegisterTypes( int nFactoryType, bool bUnregister )
    {
    ...
    const char* CPluginAnimation::ListCVars() const
    {
        return "..."; // TODO: Enter CVARs/Commands here if you have some
    }

    const char* CPluginAnimation::GetStatus() const
    {
        return "OK";
    }
